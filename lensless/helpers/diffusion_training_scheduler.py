...
def train_diffusion_model(model, dataset_dir=DIFFUSERCAM_DIR, use_x0=False, timesteps=TIMESTEPS):
    loss_fn = nn.MSELoss()
        ...
        if epoch % 10 == 0:
            if use_x0:
                ...
                torch.save({
                    ...
                    'scheduler_state_dict': scheduler.state_dict(),
                    'variance': variance
                }, f"diffusion_model_{epoch}_64_1024.pth")


def train(timesteps=TIMESTEPS, dataset_dir=DIFFUSERCAM_DIR):
